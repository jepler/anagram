...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'ana.data';
      var REMOTE_PACKAGE_BASE = 'ana.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_ana.data');

      };
      Module['addRunDependency']('datafile_ana.data');
   ...
   loadPackage({"files": [{"filename": "/words", "start": 0, "end": 588381, "audio": 0}], "remote_package_size": 588381, "package_uuid": "2e963c62-e9f0-440c-90e2-bfd2ab48b410"});
